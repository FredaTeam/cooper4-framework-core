package org.freda.cooper4.framework.core.json;
...
import org.freda.cooper4.framework.core.datastructure.impl.BaseDto;
import org.freda.cooper4.framework.core.utils.FredaUtils;

import java.util.List;

/**
 * 封装FAST JSON的 JSON工具类
 *
 * Created by rally on 2016/11/14.
 */
public class JsonTools
{
    private static final Log log = LogFactory.getLog(JsonTools.class);
    ...
    {
        return JSON.parseArray(jsonString, Dto.class);
    }
}
