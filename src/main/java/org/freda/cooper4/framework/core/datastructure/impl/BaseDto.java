package org.freda.cooper4.framework.core.datastructure.impl;

import org.apache.ibatis.type.Alias;
import org.freda.cooper4.framework.core.datastructure.Dto;
import org.freda.cooper4.framework.core.json.JsonTools;
import org.freda.cooper4.framework.core.utils.TypeCastUtils;
...
public class BaseDto extends HashMap implements Dto,Serializable
{
    ...
    {
        Object obj = TypeCastUtils.convert(get(key), "Timestamp", "yyyy-MM-dd HH:mm:ss");
        if (obj != null)
    ...
    {
        String strJson = null;
        strJson = JsonTools.encodeObject2Json(this);
        return strJson;
    }
    ...
    /**
     * 将对象转化为get请求的参数Str
     * 这个方法可以用作ModelAndView 对象内部 new RedirectView(String url)中的 url
     * 最偶转换的计算过就会变成一个 key1=val1&key2&val2的字符串
     * 然后需要加一个？
     * @return
     */
    @Override
    public String toParamsString()
    {
        ...
        return paramsStr.equals("") ? "" : paramsStr.substring(0,paramsStr.length()-1);
    }
}
